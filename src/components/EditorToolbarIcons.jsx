...
export function IconNumberList() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden focusable="false">
      <path fill="currentColor" d="M2 17h2v.5H3v1h1v1.5H2v1h3v-4H2v1zm1-9h1V4H2v1h1v3zm-1 3h1.8L2 13.1v.9h3v-1H3.2L5 10.9V10H2v1zm5-6v2h14V5H7zm0 14h14v-2H7v2zm0-6h14v-2H7v2z" />
    </svg>
  )
}
...
export function IconTable() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden focusable="false">
      <path fill="currentColor" d="M10 3H4v7h6V3zm0 8H4v10h6V11zm2-8h8v7h-8V3zm8 8h-8v10h8V11z" />
    </svg>
  )
}
...
export function IconFillLine() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden focusable="false">
      <path fill="currentColor" d="M3 15h18v2H3v-2zm0-4h12v2H3v-2z" />
    </svg>
  )
}
...
export function IconFormat() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden focusable="false">
      <path fill="currentColor" d="M5 4v3h5.5v12h3V7H19V4H5zm14 7.5c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
    </svg>
  )
}
...
export function IconAudioWave() {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden focusable="false">
      <path fill="currentColor" d="M3 10v4h2v-4H3zm4 2v2h2v-2H7zm4-4v8h2V8h-2zm4 3v2h2v-2h-2zm4-5v10h2V6h-2z" />
    </svg>
  )
}

export function IconHeading({ level = 1 }) {
  const label = level === 1 ? 'H1' : 'H2'
  return (
    <span className="doc-editor__icon-text" aria-hidden>{label}</span>
  )
}
