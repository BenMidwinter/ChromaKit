...
export function getProgressNotes(clientId) {
  return sortLatestFirst(
    db.progressNotes.filter(n => n.client_id === clientId),
    'session_date',
  )
}
...
export function getProgressNote(noteId) {
  return db.progressNotes.find(n => n.id === noteId) || null
}

export function getProgressNoteByAppointment(appointmentId) {
  return db.progressNotes.find(n => n.appointment_id === appointmentId) || null
}
