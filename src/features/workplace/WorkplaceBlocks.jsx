...
import WorkplaceBrandingPanel from './WorkplaceBrandingPanel'
...
export default function WorkplaceClinicianBlock({
  ...
  return (
    <RoleBlockShell
      ...
      description="Your colleagues and their roles."
    >
      {myWorkplace && (
...
/** Workplace letterhead — separate block below team operations. */
export function WorkplaceInformationBlock({ workplaceId, userId, myWorkplace, onChanged }) {
  return (
    <RoleBlockShell blockId="workplace_information">
      <WorkplaceBrandingPanel
        workplaceId={workplaceId}
        userId={userId}
        myWorkplace={myWorkplace}
        onChanged={onChanged}
